...
# Script para corrigir definitivamente o schema do banco de dados

echo "🔧 Corrigindo schema final do banco de dados..."
...
ADD COLUMN IF NOT EXISTS dotacao_id INTEGER,
...
SELECT table_name FROM information_schema.tables WHERE table_schema = 'transparencia';

-- Verificar estrutura das tabelas principais
SELECT 'Estrutura da tabela receitas:' as status;
\d transparencia.receitas;
...
echo "✅ Schema final corrigido com sucesso!"
echo ""
echo "📊 Verificações realizadas:"
echo "   ✅ Colunas adicionadas: dotacao_id, valor_liquidado, valor_pago"
echo "   ✅ Tabelas criadas: dotacoes, instituicoes, recursos"
