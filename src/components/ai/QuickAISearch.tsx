...
interface QuickAISearchProps {
  placeholder?: string;
  searchType?: 'general' | 'contracts' | 'minutas';
  onResult?: (result: SearchResult) => void;
  className?: string;
  compact?: boolean;
}

export default function QuickAISearch({ 
      ...
      <div className={`relative ${className}`}>
        ...
        <div className="relative">
          ...
          <input
            ...
            className="block w-full pl-10 pr-12 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-purple-500 focus:border-transparent text-sm"
          />
        ...
        {/* Resultado Compacto */}
        {result && (
          <div className="mt-2 p-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm">
              ...
              <div className="mt-2 flex flex-wrap gap-1">
                {result.suggestions.slice(0, 2).map((suggestion, index) => (
                  <button
                    ...
                    className="px-2 py-1 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 text-xs rounded hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors duration-200"
                  >
                    {suggestion}
                  </button>
                ))}
