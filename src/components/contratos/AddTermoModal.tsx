        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-gray-100 ${
                  errors.valor_aditivo ? 'border-red-500 dark:border-red-400' : 'border-gray-300 dark:border-gray-600'
                }`}
                placeholder="0,00"
              />
              {errors.valor_aditivo && (
                <p className="mt-1 text-sm text-red-600 dark:text-red-400">{errors.valor_aditivo}</p>
              )}
              {aditivoWarning && (
          ...
          <div>
            ...
            <textarea
              ...
              className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-gray-100 ${
                errors.justificativa ? 'border-red-500 dark:border-red-400' : 'border-gray-300 dark:border-gray-600'
              }`}
              rows={3}
              placeholder="Justifique a necessidade deste termo..."
            />
            {errors.justificativa && (
              <p className="mt-1 text-sm text-red-600 dark:text-red-400">{errors.justificativa}</p>
            )}
          </div>
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-gray-100 ${
                errors.data_vigencia ? 'border-red-500 dark:border-red-400' : 'border-gray-300 dark:border-gray-600'
              }`}
            />
            {errors.data_vigencia && (
              <p className="mt-1 text-sm text-red-600 dark:text-red-400">{errors.data_vigencia}</p>
            )}
          </div>
          ...
          <div className="flex justify-end gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
            ...
            <button
              type="submit"
              disabled={loading}
              className="px-4 py-2 bg-blue-600 dark:bg-blue-700 text-white rounded-md hover:bg-blue-700 dark:hover:bg-blue-600 disabled:opacity-50 transition-colors"
            >
