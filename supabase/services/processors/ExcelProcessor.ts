...
export class ExcelProcessor {
  ...
  async process(fileImport: FileImport, diretoria?: string): Promise<void> {
    try {
      ...
      // Simular leitura do arquivo Excel
  ...
  private async readExcelFile(filePath: string): Promise<XLSX.WorkBook> {
    ...
    // Simular dados reais de Excel baseados nos contratos migrados
    const mockData = this.generateMockExcelData();
    return XLSX.utils.book_new();
  }

  private generateMockExcelData(): any[][] {
    ...
    return [
      ...
      ['2018.37', '37', 2018, '12871/2018', 'MERCADO E PARCERIAS', 'ADESÃO A ATA - SRP', 'TS CONSULTORIA EMPRESARIAL LTDA', '06.033.739/0001-86', 'CONSULTORIA PROJETOS', '2023-07-13', 12, 'meses', 12535373.49, '2023-07-13', 'MARGARETH RAQUEL MIGUEL', null, 'CAMILA DA COSTA ANHAIA', 'MARIANA RIBEIRO SORRENTINO VALENTIM', 'CODEMAR', 'TS CONSULTORIA EMPRESARIAL LTDA', '06.033.739/0001-86', 12535373.49, '2023-07-13', '2023-07-13', 'ENCERRADO', null, 'MERCADO E PARCERIAS', null, null],
      ['2018.40', '40', 2018, '17875/2018', 'ADMINISTRAÇÃO E FINANÇAS', 'PROCEDIMENTO LICITATORIO', 'NOVO HORIZONTE JACAREPAGUA', '00.185.997/0001-00', 'USO DE ATA - LOCAÇÃO DE CONTAINER PARA CODEMAR', '2023-08-23', 12, 'meses', 62702.40, '2023-08-23', 'RODRIGO DE LIMA CORREIA', null, 'JANAINA SOUZA DA CONCEIÇÃO', 'BÁRBARA ALINE SOUZA TELLES', 'CODEMAR', 'NOVO HORIZONTE JACAREPAGUA', '00.185.997/0001-00', 62702.40, '2023-08-23', '2023-08-23', 'ENCERRADO', null, 'ADMINISTRAÇÃO E FINANÇAS', null, null],
      ['2018.43', '43', 2018, '17792/2018', 'OPERAÇÕES', 'USO DE ATA - SRP', 'NUCTECH DO BRASIL LTDA', '19.892.624/0001-99', 'LOCAÇÃO DE EQUIPAMENTOS DE RAIO-X', '2023-08-28', 12, 'meses', 66368.40, '2023-08-28', 'BRUNO MARINHO DE OLIVEIRA LOPES', null, 'ROBERTA SANTOS DA SILVA', 'FREDERICO MATTOS FERREIRA AZEREDO', 'CODEMAR', 'NUCTECH DO BRASIL LTDA', '19.892.624/0001-99', 66368.40, '2023-08-28', '2023-08-28', 'ENCERRADO', null, 'OPERAÇÕES', null, null]
    ];
  }
  ...
  private mapRowToContrato(row: any[], headers: string[], fileImport: FileImport, diretoria?: string): Partial<ContratoImportado> {
